...
![Grafana dashboard tags](https://docs.perfana.io/docs/images/
grafana-dashboard-tags.png)
...
![Perfana template tag](https://docs.perfana.io/docs/images/
perfana-template-tag.png)
